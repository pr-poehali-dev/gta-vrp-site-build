            ...
            {currentPage === 'home' && (
              <div className="min-h-[80vh] flex items-center justify-center animate-fade-in">
                <div className="text-center max-w-4xl">
                  ...
                  <p className="text-2xl text-white/90 mb-8 leading-relaxed">Элитная корпорация Лос-Сантоса</p>
                  ...
                  <div className="grid grid-cols-3 gap-8 mt-20 max-w-3xl mx-auto">
                    <Card className="bg-white/5 backdrop-blur-md border-gold-400/20 p-6 hover:bg-white/10 transition-all duration-300">
                      <div className="text-4xl font-bold text-gold-400 mb-2">500+</div>
                      <div className="text-white/80">Сотрудников</div>
                    </Card>
                    <Card className="bg-white/5 backdrop-blur-md border-gold-400/20 p-6 hover:bg-white/10 transition-all duration-300">
                      <div className="text-4xl font-bold text-gold-400 mb-2">250%</div>
                      <div className="text-white/80">Рост за год</div>
                    </Card>
                    <Card className="bg-white/5 backdrop-blur-md border-gold-400/20 p-6 hover:bg-white/10 transition-all duration-300">
                      <div className="text-4xl font-bold text-gold-400 mb-2">#1</div>
                      <div className="text-white/80">В рейтинге</div>
                    </Card>
                  </div>
                </div>
              </div>
                ...
                <Card className="bg-black/40 backdrop-blur-md border-gold-400/30 p-12">
                  ...
                  <div className="space-y-6 text-lg text-white/90 leading-relaxed">
                    ...
                    <p className="text-xl text-gold-400 font-semibold">
                      Мы не просто предоставляем услуги — мы создаём эксклюзивный опыт для тех, кто привык к совершенству.
                    </p>
                  </div>
                </Card>
              </div>
